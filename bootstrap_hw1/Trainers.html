  ...
  <body>
            ...
            <div class="col-sm">
              <nav class="main-menu float-left">
                <ul class="top-menu d-flex flex-row navigation top-menu justify-content-start list-unstyled ">
                        ...
                        <li class="menu-item"><a href="about-us.html">Hakkımızda</a></li>
    ...
    <section>
      <div class="container">
        ...
        <img src="img/egitmenler.jpg" class="card-img-top" alt="Eğitmenler">
          <div class="card-body">
            <p class="card-text">Akademi, TDK açıklaması ile kendi eğitmen kadrosunu yetiştiren kurum. Gerçek bir akademik kurum olarak kendi Eğitmen - Gözlemci kadromuzu kendimiz yetiştiriyoruz. Sahip olduğumuz birikim ve tecrübelerimizi kendi yetiştirdiğimiz kadromuz ile geleceğe aktarıyoruz</p>
